...
normal_cfmedip_sample_8_gr <- GRanges(readGAlignmentPairs("~/bam_directory/file.bam"))
...
save(normal_cfmedip_sample_8_mode_gr_cpgprop, file="~/output/normal_cfmedip_sample_8/normal_cfmedip_sample_8_mode_gr_cpgprop.RData")
...
save(normal_cfmedip_sample_8_mode_df_output, file="~/output/normal_cfmedip_sample_8/normal_cfmedip_sample_8_mode_df_R.RData")
...
save(normal_cfmedip_sample_8_mode_df_obsvsexp, file="~/output/normal_cfmedip_sample_8/normal_cfmedip_sample_8_mode_df_obsvsexp.RData")
