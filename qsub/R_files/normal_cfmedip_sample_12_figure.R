...
normal_cfmedip_sample_12_gr <- GRanges(readGAlignmentPairs("/cluster/projects/scottgroup/questionable_people/justin/Projects/OSCC_MeDIP/output/HNC_vs_Norm_pilot/cfDNA/bam_files/bwamem/rmdup/3598_Norm_S1_L001_rmdup.bam"))
...
save(normal_cfmedip_sample_12_mode_gr_cpgprop, file="/cluster/projects/scottgroup/questionable_people/justin/Projects/cfMeDIP_Protocol/output/normal_cfmedip_sample_12/normal_cfmedip_sample_12_mode_gr_cpgprop.RData")
...
save(normal_cfmedip_sample_12_mode_df_output, file="/cluster/projects/scottgroup/questionable_people/justin/Projects/cfMeDIP_Protocol/output/normal_cfmedip_sample_12/normal_cfmedip_sample_12_mode_df_R.RData")
...
save(normal_cfmedip_sample_12_mode_df_obsvsexp, file="/cluster/projects/scottgroup/questionable_people/justin/Projects/cfMeDIP_Protocol/output/normal_cfmedip_sample_12/normal_cfmedip_sample_12_mode_df_obsvsexp.RData")
