...
normal_cfmedip_sample_17_mode <- normal_cfmedip_sample_17_widths[normal_cfmedip_sample_17_widths == max(normal_cfmedip_sample_17_widths)]
normal_cfmedip_sample_17_index <- as.numeric(normal_cfmedip_sample_17_mode)
normal_cfmedip_sample_17_mode <- as.numeric(names(normal_cfmedip_sample_17_mode))
normal_cfmedip_sample_17_mode_gr <- normal_cfmedip_sample_17_gr[width(normal_cfmedip_sample_17_gr) == normal_cfmedip_sample_17_mode]
...
set.seed(0)
index <- sample(1:length(chr_allmainchrs_167), nrow(normal_cfmedip_sample_17_mode_df_output))
